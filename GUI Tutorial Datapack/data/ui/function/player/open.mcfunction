...
execute as @e[type=minecraft:chest_minecart,tag=new] run function ui:menu/demo/root/open
execute as @e[type=minecraft:chest_minecart,tag=new] run function ui:minecart/load_page
